...
internal enum CoraAssets {
  internal static let accentColor = ColorAsset(name: "AccentColor")
  internal static let darkGray = ColorAsset(name: "dark_gray")
  internal static let defaultPinkColor = ColorAsset(name: "default_pink_color")
  internal static let disableLightGray = ColorAsset(name: "disable_light_gray")
  internal static let lightBlack = ColorAsset(name: "light_black")
  internal static let lightBlue = ColorAsset(name: "light_blue")
  internal static let lightGray = ColorAsset(name: "light_gray")
  internal static let coraLogoTitle = ImageAsset(name: "cora_logo_title")
