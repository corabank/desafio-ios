final class StatementDataSource {
    ...
    private lazy var person1 = Person(name: "Lucas Costa", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person2 = Person(name: "João da Silva", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person3 = Person(name: "Daniela Andrade", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person4 = Person(name: "Aut Arquitetura", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person5 = Person(name: "Leonardo Silva ME", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person6 = Person(name: "Stella Moraes", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person7 = Person(name: "Darlene Edwards", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person8 = Person(name: "Guy Edwards", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person9 = Person(name: "Theresa Simmmons", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
    
    private lazy var person10 = Person(name: "Judith Cooper", cpf: "407.130.563-56",
                                      bank: "Banco Itaú", agency: "2435", account: "43556-3")
