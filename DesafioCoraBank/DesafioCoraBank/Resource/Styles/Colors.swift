...
public extension UIColor {
    ...
    static let cbLightGray: UIColor = #colorLiteral(red: 0.9326531291, green: 0.9371840358, blue: 0.9501472116, alpha: 1)
    static let cbDarkGray: UIColor = #colorLiteral(red: 0.5445293784, green: 0.5488296747, blue: 0.5662472248, alpha: 1)
    static let cbBlack: UIColor = #colorLiteral(red: 0.2627187371, green: 0.2627619505, blue: 0.26270926, alpha: 1)
}
